...
export const AssessmentViewer = () => {
 ...
 <div className="p-6 rounded-2xl bg-foreground/[0.05] from-white/5 to-white/[0.02] border border-white/30">
 <div className="flex items-start gap-4 mb-6">
 <div className={`p-3 rounded-xl bg-foreground/[0.05] ${dimension.color}`}>
 ...
 <Check className="w-4 h-4 ink-vermilion flex-shrink-0 mt-0.5" />
 <span>{example}</span>
 </div>
 ))}
 </div>
 ...
 <div className={`p-2 rounded-lg bg-foreground/[0.05] ${dimension.color}`}>
 ...
 className="min-h-[150px] bg-black border-white/30 text-white placeholder:text-gray-500 focus:border-foreground/50"
 />
 <div className="flex items-center justify-between text-sm">
 <span className={goals.length >= 20 ? 'ink-vermilion' : 'text-gray-500'}>
 ...
 className="min-h-[80px] bg-black border-white/30 text-white placeholder:text-gray-500 focus:border-foreground/50"
 />
 </div>
 </div>
 </div>
 ...
 <div className={`inline-flex items-center justify-center w-24 h-24 rounded-full bg-foreground/[0.05] ${overallInfo.bg} border-2 border-current ${overallInfo.color}`}>
 ...
 <div className={`p-1.5 rounded-lg bg-foreground/[0.05] ${dim.color}`}>
 <IconComponent className="w-4 h-4 text-white" />
 </div>
 <div className="flex-1 min-w-0">
 ...
 <p className="text-sm ink-vermilion font-medium mb-2">Strengths</p>
 ...
 <p className="text-sm text-foreground font-medium mb-2">Your Goals</p>
 ...
 <div className="w-24 h-24 rounded-full bg-foreground/[0.05] flex items-center justify-center mx-auto mb-6 shadow-lg shadow-indigo-500/30">
 ...
 <div className="p-4 rounded-xl bg-black border border-white/30">
 <p className="text-2xl font-bold ink-vermilion">{strengths.length}</p>
 ...
 disabled={isSaving}
 className="bg-foreground/[0.05] hover:opacity-90 px-8"
 >
 {isSaving ? (
 <>
 ...
 <p className="ink-vermilion font-medium">Assessment Saved!</p>
 </div>
 <Button
 ...
 return <Sliders className="w-5 h-5 text-foreground" />;
 case 'selection':
 return <Target className="w-5 h-5 ink-vermilion" />;
 case 'goals':
 return <Sparkles className="w-5 h-5 text-foreground" />;
 case 'review':
 return <MessageSquare className="w-5 h-5 ink-vermilion" />;
 case 'completion':
 ...
 <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-foreground/30 border border-foreground/20">
 <Star className="w-4 h-4 text-foreground" />
 <span className="text-foreground font-semibold">{getOverallScore(scores).toFixed(1)}</span>
 ...
 <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-foreground/30 border border-foreground/20">
 <Star className="w-3 h-3 text-foreground" />
 <span className="text-foreground font-semibold text-xs">{getOverallScore(scores).toFixed(1)}/5</span>
 </div>
 ...
 <motion.div
 className="h-full bg-foreground/[0.05] "
 initial={{ width: 0 }}
 ...
 currentScene?.type === 'dimension' || currentScene?.type === 'multi-dimension' ? 'bg-foreground/30' :
 ...
 className="bg-foreground/[0.05] hover:opacity-90 disabled:opacity-30 px-6 shadow-lg"
 >
 Continue
