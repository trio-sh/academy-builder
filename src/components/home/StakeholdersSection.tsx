...
const readers: ReaderWithFigure[] = [
  ...
  },
  {
    ...
    title: "For Employers",
    role: "The employer",
    lede: "Add documented behavioral evidence to how you understand behavior at work — from hiring and onboarding to development and internal mobility.",
    entries: [
      "Behavioral evidence beyond the résumé",
      "Released by the individual, on their terms",
      "Verify a record without an account",
      "Evidence that informs — the decision stays yours",
    ],
    ...
    figCaption: "Fig. II · at the employer desk",
  },
  {
    n: "III",
    title: "For Schools",
