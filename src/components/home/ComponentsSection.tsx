...
const components = [
  {
    ...
    features: ["Professional Scores", "Growth History", "Mentor Endorsements", "Verification QR"],
  },
  {
    id: "growth-log",
    name: "Growth Log",
    tagline: "Development Record",
    description:
      "Your continuously evolving record of professional growth, training completions, and project outcomes.",
    icon: BarChart3,
    gradient: "from-indigo-500 to-indigo-600",
    hoverGlow: "group-hover:shadow-indigo-500/30",
    features: ["Timeline View", "Activity Record", "Growth Trends", "Export History"],
  },
  {
    id: "mentorlink",
    ...
    tagline: "Key Stage",
    description:
      "Experienced professionals provide guidance, feedback, and support throughout your development journey.",
    icon: Users,
    gradient: "from-purple-500 to-purple-600",
    hoverGlow: "group-hover:shadow-purple-500/30",
    features: ["Mentor Dashboard", "Guidance Tools", "Referral System", "Quality Assurance"],
  },
  {
    id: "bridgefast",
    name: "BridgeFast",
    ...
    description:
      "Short-form training modules (2-4 hours) addressing specific development areas recommended by your mentor.",
    icon: Rocket,
  ...
  },
  {
    ...
    description:
      "Project marketplace where candidates gain real-world experience with professional guidance and structured feedback.",
    icon: Briefcase,
  ...
  },
  {
    ...
    description:
      "Engaging students early in career awareness and professional development. A dedicated pathway for educational institutions.",
    icon: GraduationCap,
  ...
  },
  {
    ...
    description:
      "Advanced recognition for participants demonstrating exceptional workplace readiness. Silver, Gold, and Platinum tiers.",
    icon: Shield,
    gradient: "from-amber-400 to-amber-500",
    hoverGlow: "group-hover:shadow-amber-500/30",
    features: ["Nomination System", "Committee Review", "Premium Badge", "Exclusive Recognition"],
  },
  {
    id: "t3x",
    ...
    description:
      "Employer-facing marketplace where qualified candidates can be discovered. Includes follow-through insights after hiring.",
    icon: Building2,
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full bg-black backdrop-blur-xl border border-white/30 rounded-3xl p-8 group-hover:border-white/30 transition-all duration-500 overflow-hidden">
        ...
        {/* Tagline */}
        <span className="text-xs font-medium uppercase tracking-wider text-gray-500 group-hover:text-gray-50 transition-colors">
          {component.tagline}
        </span>
        ...
        {/* Description */}
        <p className="text-sm text-gray-50 group-hover:text-gray-50 leading-relaxed mb-6 transition-colors">
