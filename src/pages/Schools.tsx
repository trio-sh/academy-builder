          ...
          <div className="container px-4 md:px-6">
            ...
            >
              <motion.div
                ...
                viewport={{ once: true }}
                className="relative p-10 rounded-3xl bg-black/90 backdrop-blur-xl border border-white/30"
              >
                <span className="inline-block text-sm font-semibold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent uppercase tracking-wider mb-4">
              ...
              >
                ...
                <div className="relative rounded-3xl bg-gradient-to-br from-cyan-600/20 to-indigo-600/20 border border-white/30 p-12 backdrop-blur-xl">
