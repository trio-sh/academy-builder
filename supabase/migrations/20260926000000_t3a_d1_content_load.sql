  ...
  IF NOT EXISTS (SELECT 1 FROM public.t3a_content_object
    ...
    VALUES (v_object, 'v1', 'drafting'::t3a_approval_status,
            ...
            jsonb_build_object(
              ...
              'stage_code', $lit$S3$lit$,
              'source_sheet', $lit${"d1_situation_class":"S-1 to S-7, stated per source. This is a D1 CONSTRUCT classification and is","relevant_conduct":"without its counterpart. It states WHAT OBSERVABLE D1 CONDUCT THIS SOURCE","information_made_available":"P0 the pre-brief: former employment ending eighteen months ago, a","material_items":"Q-D1-03b2CONDITIONALServed only where 03a records an unsupported claim","information_withheld":"Whether the interest would disqualify the participant. Whether Elmsworth","assertion_reference_set":"Q-D1-04aNOT SERVEDThe source is not a responsibility-for-events","attribution_support_set":"Empty. The interest is the participant’s own and the pack provides no","enquiry_point":"**MENTOR REFERENCE CARD**","account_test_point":"Q-D1-08aDIRECTA continuing financial interest bears on the recommendation","post_test_account_opportunity":"TRUE, one working day.","available_routes":", retained deliverablesQ-D1-07DIRECTWritten account test follows the written","accountable_actor_available":"True — the requesting manager, the panel chair.","time_reference_called_for":"False. The brief sets deadlines for the deliverables but calls for","bearing_interest":",","administration_timing_protocol":"— SOURCE-SPECIFIC OVERRIDETHIS SOURCE OVERRIDES THE PART-LEVEL","source_version_hash":": assigned at registration.","approved_observation_ready_count":"ZERO.","active_serving_count":"ZERO.SECTION 1 — WHAT APPLIES TO ALL TEN1.1 Who is in the roomFICTIONAL","cross_context_map":"MANDATORY VERSION-LEVEL FIELD, and it was MISSING from every source in","route_observation_basis":"S4 — a route ACTUALLY USED WITHIN THE GROUP INTERACTION or through an","stated_standard":"CORRECTED. This field records ANY EXPLICIT RULE, REQUIREMENT, CONTROL, POLICY,","min_seconds":"and","max_seconds":": 1200 to 1800 per session.","proposed_compatibility_class":": A, proposed. randomization_seed and presentation_variant_seed:","name_clearance_status":"Governed by the launch naming rule at Part One, Section 5.5. A launch"}$lit$::jsonb,
